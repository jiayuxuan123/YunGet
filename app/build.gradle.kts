...
dependencies {
    ...
    implementation("dev.turbodl:turbodl-core:0.2.0-rc19")
    implementation("dev.turbodl:turbo-plugin-runtime:0.2.0-rc19")
    implementation("dev.turbodl:turbo-plugin-bootstrap:0.2.0-rc19")
    implementation("dev.turbodl:turbo-plugin-hls:0.2.0-rc19")
