        ...
        Column(
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "此赞赏码仅用于支持本二次开发（多线程升级）版本的维护。" +
                            "若想支持上游原项目作者，请移步原仓库 CYQawa/YunX 的捐赠渠道，两者互不相关。",
            ...
            Card(
                ...
                Row(
                    ...
                    Text(
                        text = "本版本（云取 YunGet）是基于上游 CYQawa/YunX 的二次开发，完全免费开源，" +
                            "所有功能无需赞赏即可正常使用。上方赞赏码仅面向本二次开发版；" +
                            "想支持原项目请移步上游仓库，避免权益混淆。",
                        style = MaterialTheme.typography.bodyMedium,
...
private fun saveWechatQrToGallery(context: Context): Boolean = runCatching {
    ...
    val fileName = "yunget_wechat_qr_${System.currentTimeMillis()}.jpg"
